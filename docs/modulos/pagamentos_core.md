...
- **[Contingência](/negocio/glossario_conselho.md#contingencia)**: desvia o processo para análise multi-nível (supervisor -> ordenador -> conselho) sem bloquear o status principal. Após aprovação, o efeito é aplicado ao processo e ele retoma a trilha.
- **[Devolução](/negocio/glossario_conselho.md#devolucao)**: registra reversão formal de valor ou documento, podendo ajustar o status do processo e gerar pendências.
