"""Helpers compartilhados para exportação tabular de relatórios."""
...
def gerar_csv_relatorio(queryset, tipo_relatorio):
    ...
    cabecalhos, extrator = mapa_relatorios.get(
        tipo_relatorio,
        (['Erro'], lambda x: ['Tipo não configurado']),
    )
