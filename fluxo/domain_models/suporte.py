...
class Pendencia(models.Model):
    ...
    status = models.ForeignKey("fluxo.StatusChoicesPendencias", on_delete=models.PROTECT, blank=True, null=True)
    tipo = models.ForeignKey("fluxo.TiposDePendencias", on_delete=models.PROTECT)
