...
urlpatterns = [
    ...
    path('processo/<int:pk>/editar/fiscais/', pre_payment_cadastro_panels.documentos_fiscais_view, name='processo_fiscais_detail'),
    ...
    path('pagamentos/sincronizar-siscac/divergencias/resolver/action/', pagamentos_sync_views.sincronizar_siscac_resolver_divergencias_action, name='sincronizar_siscac_resolver_divergencias_action'),
