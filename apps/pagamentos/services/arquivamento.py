...
from apps.pagamentos.services.processo_documentos import gerar_pdf_consolidado_processo
from apps.pagamentos.views.helpers.errors import ArquivamentoDefinitivoError, ArquivamentoSemDocumentosError
