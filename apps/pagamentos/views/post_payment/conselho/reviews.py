...
from apps.pagamentos.domain_models import Processo, ProcessoStatus, ReuniaoConselhoStatus
from apps.pagamentos.views.helpers import _processo_fila_detalhe_view
...
def conselho_processo_view(request, pk):
    ...
    return _processo_fila_detalhe_view(
        ...
        template_name="pagamentos/conselho_processo.html",
