...
from apps.pagamentos.domain_models import Boleto_Bancario, Processo
from apps.pagamentos.services.acoes_lote import atualizar_status_em_lote, obter_processos_elegiveis_por_status
