...
class Processo(models.Model):
    ...
    class Meta:
        permissions = [
            ...
            ("pode_aprovar_contingencia_ordenador", "Pode aprovar contingências na etapa do Ordenador de Despesa"),
            ("pode_aprovar_contingencia_conselho", "Pode aprovar contingências na etapa do Conselho Fiscal"),
            ("pode_revisar_contingencia_contadora", "Pode realizar a revisão contábil final de contingências"),
    ...
    def _persist_pending_documento_orcamentario(self):
        ...
        if any(value not in (None, "") for value in (numero_nota_empenho, data_empenho, ano_exercicio)):
            ...
            from apps.pagamentos.domain_models.documentos import DocumentoOrcamentario
    ...
    def _atribuir_status_manual(self, nome_status):
        ...
        from apps.pagamentos.domain_models.catalogos import StatusOpcoesProcesso
    ...
    def avancar_status(self, novo_status_str, usuario=None):
        ...
        from apps.pagamentos.domain_models.catalogos import StatusOpcoesProcesso
        from apps.pagamentos.services.integracoes.processo_relacionados import sincronizar_relacoes_apos_transicao
