...
from apps.pagamentos.views.pre_payment.cadastro import actions as cadastro_actions
...
def _create_backoffice_user():
    ...
    permissao = Permission.objects.get(codename="pode_editar_processos_pagamento", content_type__app_label="pagamentos")
