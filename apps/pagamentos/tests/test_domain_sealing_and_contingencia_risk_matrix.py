...
from apps.pagamentos.domain_models import Contingencia, ProcessoStatus
from apps.pagamentos.validators import verificar_turnpike
from apps.pagamentos.views.helpers.contingencias import (
    aplicar_aprovacao_contingencia,
    normalizar_dados_propostos_contingencia,
)
from apps.pagamentos.views.pre_payment.cadastro.actions import _status_bloqueia_gestao_fiscal
