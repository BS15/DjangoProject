...
from apps.verbas_indenizatorias.forms import ContingenciaDiariaForm
from apps.verbas_indenizatorias.models import ContingenciaDiaria, Diaria
from apps.verbas_indenizatorias.services.contingencia import (
...
def add_contingencia_diaria_action(request, pk):
    ...
    if not form.is_valid():
        ...
        return redirect("verbas_indenizatorias:contingencia_diaria_create", pk=pk)
