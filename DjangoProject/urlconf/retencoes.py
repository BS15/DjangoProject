...
from apps.pagamentos.views.pre_payment.liquidacoes import actions as liquidacoes_actions
from apps.pagamentos.views.pre_payment.cadastro import panels as documentos_fiscais_panels
from apps.pagamentos.views.pre_payment.cadastro import apis as documentos_fiscais_apis
