...
urlpatterns = [
    ...
    path('impostos/selecionar-documentos-pagamento/', impostos_actions.selecionar_retencoes_documentacao_action, name='selecionar_retencoes_documentacao_action'),
    path('impostos/registrar-documentos-pagamento/', impostos_panels.registrar_documentos_pagamento_view, name='registrar_documentos_pagamento_view'),
    path('impostos/registrar-documentos-pagamento/remover/', impostos_actions.remover_retencao_documentacao_action, name='remover_retencao_documentacao_action'),
    path('impostos/registrar-documentos-pagamento/salvar/', impostos_actions.registrar_documentos_pagamento_action, name='registrar_documentos_pagamento_action'),
