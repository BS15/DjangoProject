...
from processos.views import assinaturas as assinatura_views
from processos.views import cadastros as cadastro_views
from processos.views import contas as conta_views
from processos.views import desenvolvedor as dev_views
from processos.views import relatorios as relatorio_views
...
urlpatterns = [
    ...
    path('importar-siscac/', dev_views.painel_importacao_view, name='painel_importacao'),
    path('importar-siscac/template-credores/', dev_views.download_template_csv_credores, name='template_csv_credores'),
    path('importar-siscac/template-contas/', dev_views.download_template_csv_contas, name='template_csv_contas'),
