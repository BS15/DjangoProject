...
urlpatterns = [
    ...
    path('suprimentos/novo/', suprimento_cadastro_actions.add_suprimento_view, name='add_suprimento_view'),
    path('suprimentos/novo/', suprimento_cadastro_actions.add_suprimento_view, name='add_suprimento_action'),
