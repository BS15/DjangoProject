...
urlpatterns = [
    ...
    path('verbas/diarias/nova-assinada/action/', verbas_diarias_actions.add_diaria_assinada_action, name='add_diaria_assinada_action'),
    ...
    path('verbas/diarias/autorizar/', verbas_diarias_panels.painel_autorizacao_diarias_view, name='painel_autorizacao_diarias'),
    ...
    path('verbas/prestacoes/revisar/iniciar/', verbas_diarias_actions.iniciar_revisao_prestacoes_action, name='iniciar_revisao_prestacoes'),
    path('verbas/prestacoes/revisar/sair/', verbas_diarias_actions.sair_revisao_prestacoes_action, name='sair_revisao_prestacoes'),
    ...
    path('verbas/reembolsos/<int:pk>/gerenciar/cancelar/', verbas_reembolso_panels.cancelar_reembolso_spoke_view, name='cancelar_reembolso_spoke'),
    ...
    path('verbas/jetons/<int:pk>/gerenciar/cancelar/', verbas_jeton_panels.cancelar_jeton_spoke_view, name='cancelar_jeton_spoke'),
    ...
    path('verbas/auxilios/<int:pk>/gerenciar/cancelar/', verbas_auxilio_panels.cancelar_auxilio_spoke_view, name='cancelar_auxilio_spoke'),
