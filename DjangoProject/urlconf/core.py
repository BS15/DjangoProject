...
urlpatterns = [
    ...
    path('processos/conferencia/<int:pk>/aprovar/', post_payment_conferencia_actions.aprovar_conferencia_view, name='aprovar_conferencia'),
    path('processos/enviar-autorizacao/', payment_contas_actions.enviar_para_autorizacao, name='enviar_para_autorizacao'),
    ...
    path('processos/autorizacao/<int:pk>/recusar/', payment_autorizacao_actions.recusar_autorizacao_view, name='recusar_autorizacao'),
    path('processos/contabilizacao/', post_payment_contabilizacao_panels.painel_contabilizacao_view, name='painel_contabilizacao'),
    path('processos/contabilizacao/iniciar/', post_payment_contabilizacao_actions.iniciar_contabilizacao_view, name='iniciar_contabilizacao'),
    ...
    path('processos/contabilizacao/<int:pk>/aprovar/', post_payment_contabilizacao_actions.aprovar_contabilizacao_view, name='aprovar_contabilizacao'),
    path('processos/contabilizacao/<int:pk>/recusar/', post_payment_contabilizacao_actions.recusar_contabilizacao_view, name='recusar_contabilizacao'),
    ...
    path('processos/conselho/<int:pk>/aprovar/', post_payment_conselho_actions.aprovar_conselho_view, name='aprovar_conselho'),
    path('processos/conselho/<int:pk>/recusar/', post_payment_conselho_actions.recusar_conselho_view, name='recusar_conselho'),
    ...
    path('processos/conselho/reunioes/<int:reuniao_id>/iniciar/', post_payment_reunioes_actions.iniciar_conselho_reuniao_view, name='iniciar_conselho_reuniao'),
    ...
    path('processos/marcar-lancado/', payment_lancamento_actions.marcar_como_lancado, name='marcar_como_lancado'),
    path('processos/desmarcar-lancamento/', payment_lancamento_actions.desmarcar_lancamento, name='desmarcar_lancamento'),
